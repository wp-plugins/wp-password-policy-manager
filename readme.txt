...
Tags: wordpress password policy, password policy, password policy manager, wordpress password, password strength, password, authentication, security, wordpress user password
...
Your WordPress users do not have to get used to new systems and interfaces because WP Password Policy Manager integrates seamlessly within your WordPress login page and uses the standard WordPress UI as can be seen from these [screenshots](http://wordpress.org/plugins/wp-password-policy-manager/screenshots/). 

= Configurable WordPress Password Policies =
* WordPress administrators can configure the password age from the Password Policy node in WordPress settings
...
2. Administrators can configure password page from the Password Policies node in WordPress settings 
